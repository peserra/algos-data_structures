...
int main()
{
    ...
    while (scanf(" %c", &op) != EOF)
    {
        ...
        case 'I':
            scanf(" %c", &x);
            inserir(lista, x);
            //imprimeLista(lista);  //debug        
            break;
        case 'B':
            scanf(" %c", &x);
            int retorno = buscaValor(lista, q, x);
            //printf("RETORNOU: %d  ", retorno); debug
        ...
        case 'R':
            ...
            //imprimeLista(lista);  //debug 
            remover(lista, x);
            //printf("Remover: %c   quantidade = %d\n", x,lista->quantidade); //debug           
