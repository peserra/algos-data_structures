...
int buscaFolhas(Item *i)
{
    ...
    if (i != NULL)
    {
        ...
        {
            return 1; //se é folha, vai retornar 1, que vai ser somado em cada recursao
        }
        else
        {
            return buscaFolhas(i->esq) + buscaFolhas(i->dir);
        }
...
{
    //printf("Folhas: ");
    int numFolhas = buscaFolhas(arv->raiz);
    printf("%d\n", numFolhas);
    printf("\n");
}
